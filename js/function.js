(function ($) {
	...
	/* consultation slider */
	var swiper = new Swiper('.consultation-slider', {
		autoplay: {
			delay: 3000,
		},
		speed: 1000,
	...
	/* consultation page*/
	$("#consultations-section").load("sections/consultations.html", function () {
		// Initialize Swiper after consultations are loaded
		var swiper = new Swiper('.consultation-slider', {
			autoplay: {
				delay: 3000,
			},
